...
<section class="formulario">
    <div class="form">
        <form id="inscricao" method="POST" action="enviar-email-caravana.php">
            <h2>INSCRIÇÃO</h2>
            
            <!-- Container para múltiplas inscrições -->
                ...
                <div class="inscricao-set">
                    ...
                    <div class="div pag">
                        ...
                        <select name="lote[]" id="mySelect" required>
                            ...
                            <option value="1" class="option">Lote 1 R$65,00</option>
                            <option value="2" class="option" disabled> ̶L̶o̶t̶e̶ ̶2̶ ̶R̶$̶7̶5,̶0̶0̶ INDISPONÍVEL</option>
                            <option value="3" class="option" disabled> ̶L̶o̶t̶e̶ ̶3̶ ̶R̶$̶8̶5,̶0̶0̶ INDISPONÍVEL</option>
                        </select>
                    </div>
                    <br>
                </div>
            ...
            <button type="button" id="add-inscricao">Adicionar Inscrição</button>
            <div class="enviar">
                <button type="submit" name="submit" class="glow-on-hover">INSCREVA-SE</button>
            </div>
        </form>
    </div>
</section>
...
<script>
    ...
    var container = document.getElementById('inscricoes-container');
    var newInscricaoSet = document.querySelector('.inscricao-set').cloneNode(true);
    
    // Limpa os valores dos campos clonados
    newInscricaoSet.querySelectorAll('input').forEach(input => {
        input.value = '';
    });

    container.appendChild(newInscricaoSet);
});
